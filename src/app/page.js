...
export default function Home() {
  ...
  return (
    <main>
      <HeroBanner customClass="homepage-hero flex justify-center items-center relative" title="Develop your abilities and enhance your professional journey." isHomePage={true}/>
      {/* Render the Courses */}
      <DataStripe dataArray = {dataStripeInfo}/>

      <Courses title="Courses" isHomePage={true}/>
      {/* Get started Banner */}
      ...
      <div className='bg-gray-800 text-white flex items-center pt-6 py-3 md:h-[100px] mt-6'>
        <div className='container mx-auto flex justify-center items-center md:items-center md:flex-row flex-col'>
          ...
          <button>
          <Link href="/courses" type="button" className=" md:mt-0 p-4 text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-3xl text-sm px-3 py-3 focus:outline-none ">Register Now!</Link>
          </button>
          </div>
        </div>
      </div>
        ...
        <div className='bg-white w-full py-3'>
         <div className='container lg:flex items-center py-3 justify-between m-auto'>
          <div className='lg:mb-0 mb-3'>
            ...
            <h4 className='text-gray-600 font-semibold'>the quick fox jumps over the lazy dog</h4>
          </div>
          <button className='text-white bg-orange-500 rounded-xl p-3'>Contact Us</button>
